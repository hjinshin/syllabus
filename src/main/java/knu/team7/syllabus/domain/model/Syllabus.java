...
public class Syllabus {
    ...
    @Builder
    public Syllabus(String crseNo, String crseGoal, String eduGoal, String summary, String textbook, String evalMethd, String intviTimeLoc, String refer, String profNm, String profTel, String profEmail, String preSbjet, String postSbjet, String attendance, String midExam, String finalExam, String assignment, String presentation, String debate, String safetyEdu, String etc, String total) {
        this.crseNo = crseNo;
